...
export class personnameController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/personname/:id', this.GpDelete);
this.router.get('/personname/get/search', this.GpSearch);
this.router.put('/personname/get/update', this.GpSearchForUpdate);
this.router.put('/personname', this.GpUpdate);
this.router.get('/personname', this.GpGetAllValues);
this.router.post('/personname', this.GpCreate);
    }
